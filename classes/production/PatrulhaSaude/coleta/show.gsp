...
<html>
    ...
    <body>
        ...
        <div id="show-coleta" class="content scaffold-show" role="main">
            ...
            <f:display bean="coleta" />
            <g:form resource="${this.coleta}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.coleta}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
